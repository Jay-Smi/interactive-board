...
import {
    colorToCss,
    connectionIdToColor,
    findInterectingLayersWithRectangle,
...
const Canvas = ({ boardId }: CanvasProps) => {
    ...
    const updateSelectionNet = useMutation(
        ({ storage, setMyPresence }, current, origin) => {
            ...
            const ids = findInterectingLayersWithRectangle(
                layerIds,
                layers,
                origin,
                current
    ...
    const startMultiSelection: (current: Point, origin: Point) => void =
        useCallback((current: Point, origin: Point) => {
            if (
    ...
    return (
        <main className="h-full w-full ralative bg-neutral-100 touch-none">
